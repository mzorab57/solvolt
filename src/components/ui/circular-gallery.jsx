          ...
          {items.map((item, i) => {
            ...
            return (
              <div
                ...
                className="absolute lg:w-[300px]  w-[230px] pl-5 h-[300px] lg:h-[400px] rounded-lg"
                style={{
                ...
                <div
                  className="relative w-full h-64 lg:h-full rounded-lg shadow-2xl overflow-hidden group   backdrop-blur-lg">
                  <img
                    src={item.photo.url}
                    alt={item.photo.text}
