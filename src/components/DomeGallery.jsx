...
const DEFAULT_IMAGES = [
  ...
  {
    src: 'https://images.unsplash.com/photo-1497440001374-f26997328c1b?w=800&auto=format&fit=crop',
    alt: 'UPS system'
  },
  {
  ...
  {
    src: 'https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=800&auto=format&fit=crop',
    alt: 'Battery storage'
  },
  {
  ...
  {
    src: 'https://images.unsplash.com/photo-1466611653911-95081537e5b7?w=800&auto=format&fit=crop',
    alt: 'Power management'
  },
  {
    src: 'https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?w=800&auto=format&fit=crop',
      ...
      >
        ...
        >
          <div className="stage">
            <div ref={sphereRef} className="sphere">
              {items.map((it, i) => (
                ...
                >
                  <div
                    className="item__image absolute size-24 block overflow-hidden cursor-pointer bg-gray-200 transition-transform duration-300"
                    role="button"
                    tabIndex={0}
          ...
          <div
            ...
            style={{
              backgroundImage: `radial-gradient(rgba(235, 235, 235, 0) 85%, var(--overlay-blur-color, ${overlayBlurColor}) 100%)`
            }}
          />
